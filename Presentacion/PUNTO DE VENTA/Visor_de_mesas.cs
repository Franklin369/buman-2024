...
namespace RestCsharp.Presentacion.PUNTO_DE_VENTA {
    public partial class Visor_de_mesas : UserControl {
        ...
        private void ImprimirarearBar() {

            string codigoarea = "bar";
            var funciondv = new Ddetalleventas();
            var parametrosdv = new Ldetalleventas();
            var dtdv = new DataTable();
            parametrosdv.idventa = idventa;
            parametrosdv.codigoareaimpresion = codigoarea;
            funciondv.rptTicketCocinaXcodigoarea(ref dtdv,parametrosdv);
            if (dtdv.Rows.Count > 0) {
                ...
                funcionImpresoras.ImprimirVarios(rptComunicador.ReportSource,codigoarea);
                }

            }
        private void ImprimirCocina() {

            string codigoarea = "pedidos";
            var funciondv = new Ddetalleventas();
            var parametrosdv = new Ldetalleventas();
            var dtdv = new DataTable();
            parametrosdv.idventa = idventa;
