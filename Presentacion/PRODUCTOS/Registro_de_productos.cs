...
namespace RestCsharp.Presentacion.PRODUCTOS
{
    public partial class Registro_de_productos : UserControl
    {
        ...
        private void Insertar_Producto()
        {
            ...
            parametros.Idareaimprimir = Convert.ToInt32(txtarea.SelectedValue);
        ...
        private void MostrarareasImpresion()
        {
            DataTable dt = new DataTable();
            var funcion = new Dareasimpresion();
            funcion.mostrarAreasImpresionProductos(ref dt);
            txtarea.DisplayMember = "Area";
            txtarea.ValueMember = "Id_area";
        ...
        private void ObtenerColorxproducto()
        {
            ...
            Idareaimprimir = Convert.ToInt32(dt.Rows[0][9]);
        ...
        private void mostrarAreaImprimirXid()
        {
            var funcion = new Dareasimpresion();
            var parametros = new Lareasimpresion();
            var dt = new DataTable();
            parametros.Id_area = Idareaimprimir;
            funcion.mostrarAreasProductosXidarea(ref dt, parametros);
